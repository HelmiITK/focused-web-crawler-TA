...
# 2. Load model KNN
knn = joblib.load('save_model/knn_model_k4.pkl')
...
if __name__ == "__main__":
    teks_baru = "learning management system lms pada kursus online berbasis deteksi kecurangan ujian menggunakan model mediapipe face"
